...
@Schema(name = "Quantity", description = "Quantity entity.")
...
public class Quantity {
  ...
  public enum TypeEnum {
    ...
    AMORTISED_VALUE("amortisedValue"),
    
    DIGITAL_TOKEN_UNIT("digitalTokenUnit");
   ...
   */
  public Quantity(TypeEnum type, BigDecimal value) {
    this.type = type;
    this.value = value;
  }

  public Quantity type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   */
  @NotNull 
  @Schema(name = "type", example = "unit", description = "Specifies the type of the amount.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("type")
