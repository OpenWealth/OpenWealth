...
@Schema(name = "FxForward", description = "A forward contract is a customized contract between two parties to buy or sell currencies at a specified price on a future date.")
...
public class FxForward implements FinancialInstrument {
  ...
  private CurrencyAmount amountPaid;
   ...
   */
  public FxForward(FinancialInstrumentType type, String name, CurrencyAmount amountPaid, CurrencyAmount amountReceived, LocalDate maturityDate) {
    this.type = type;
    this.name = name;
  ...
  public FxForward type(FinancialInstrumentType type) {
    this.type = type;
    return this;
  }
  ...
  public FxForward name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FxForward identificationList(List<@Valid FinancialInstrumentIdentification> identificationList) {
    this.identificationList = identificationList;
    return this;
  }

  public FxForward addIdentificationListItem(FinancialInstrumentIdentification identificationListItem) {
  ...
  public FxForward cfiCode(String cfiCode) {
  ...
  public FxForward currencyOfDenomination(String currencyOfDenomination) {
  ...
  public FxForward hasFactor(Boolean hasFactor) {
  ...
  public FxForward factor(BigDecimal factor) {
    this.factor = factor;
    return this;
  }
  ...
  public FxForward additionalDetails(String additionalDetails) {
  ...
  public FxForward amountPaid(CurrencyAmount amountPaid) {
    this.amountPaid = amountPaid;
    return this;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "amountPaid", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("amountPaid")
  public CurrencyAmount getAmountPaid() {
    return amountPaid;
  }

  public void setAmountPaid(CurrencyAmount amountPaid) {
    this.amountPaid = amountPaid;
  }

  public FxForward amountReceived(CurrencyAmount amountReceived) {
    this.amountReceived = amountReceived;
    return this;
  }
   ...
   */
  @NotNull @Valid 
  @Schema(name = "amountReceived", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public FxForward maturityDate(LocalDate maturityDate) {
    this.maturityDate = maturityDate;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, fxForward.type) &&
        Objects.equals(this.name, fxForward.name) &&
        Objects.equals(this.identificationList, fxForward.identificationList) &&
        Objects.equals(this.cfiCode, fxForward.cfiCode) &&
        Objects.equals(this.currencyOfDenomination, fxForward.currencyOfDenomination) &&
        Objects.equals(this.hasFactor, fxForward.hasFactor) &&
        Objects.equals(this.factor, fxForward.factor) &&
        Objects.equals(this.additionalDetails, fxForward.additionalDetails) &&
        Objects.equals(this.amountPaid, fxForward.amountPaid) &&
        Objects.equals(this.amountReceived, fxForward.amountReceived) &&
        Objects.equals(this.maturityDate, fxForward.maturityDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, name, identificationList, cfiCode, currencyOfDenomination, hasFactor, factor, additionalDetails, amountPaid, amountReceived, maturityDate);
  }
