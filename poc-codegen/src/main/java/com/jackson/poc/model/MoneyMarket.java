...
@Schema(name = "MoneyMarket", description = "The money market schema covers both fixed and callable loans and deposits.")
...
public class MoneyMarket implements FinancialInstrument {
   ...
   */
  public MoneyMarket(FinancialInstrumentType type, String name, CurrencyAmount principalAmount) {
    this.type = type;
    this.name = name;
    this.principalAmount = principalAmount;
  }

  public MoneyMarket type(FinancialInstrumentType type) {
    this.type = type;
    return this;
  }
  ...
  public MoneyMarket name(String name) {
    this.name = name;
    return this;
  }
  ...
  public MoneyMarket identificationList(List<@Valid FinancialInstrumentIdentification> identificationList) {
    this.identificationList = identificationList;
    return this;
  }

  public MoneyMarket addIdentificationListItem(FinancialInstrumentIdentification identificationListItem) {
  ...
  public MoneyMarket cfiCode(String cfiCode) {
  ...
  public MoneyMarket currencyOfDenomination(String currencyOfDenomination) {
  ...
  public MoneyMarket hasFactor(Boolean hasFactor) {
  ...
  public MoneyMarket factor(BigDecimal factor) {
    this.factor = factor;
    return this;
  }
  ...
  public MoneyMarket additionalDetails(String additionalDetails) {
  ...
  public MoneyMarket principalAmount(CurrencyAmount principalAmount) {
    this.principalAmount = principalAmount;
    return this;
  }
  ...
  public MoneyMarket interestRate(InterestRate interestRate) {
  ...
  public MoneyMarket maturityDate(LocalDate maturityDate) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, moneyMarket.type) &&
        Objects.equals(this.name, moneyMarket.name) &&
        Objects.equals(this.identificationList, moneyMarket.identificationList) &&
        Objects.equals(this.cfiCode, moneyMarket.cfiCode) &&
        Objects.equals(this.currencyOfDenomination, moneyMarket.currencyOfDenomination) &&
        Objects.equals(this.hasFactor, moneyMarket.hasFactor) &&
        Objects.equals(this.factor, moneyMarket.factor) &&
        Objects.equals(this.additionalDetails, moneyMarket.additionalDetails) &&
        Objects.equals(this.principalAmount, moneyMarket.principalAmount) &&
        Objects.equals(this.interestRate, moneyMarket.interestRate) &&
        Objects.equals(this.maturityDate, moneyMarket.maturityDate);
  }
