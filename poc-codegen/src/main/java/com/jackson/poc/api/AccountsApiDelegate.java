...
public interface AccountsApiDelegate {
     ...
     * @see AccountsApi#getAccountPositionByAccountId
     */
    default ResponseEntity<List<ValuatedPosition>> getAccountPositionByAccountId(String accountId,
        LocalDate date,
     ...
     *         or Not Implemented - The server does not support the functionality required to fulfill the request. (status code 501)
     *         or Service Unavailable - The server is currently unable to handle the request due to a temporary overload or scheduled maintenance. (status code 503)
     * @see AccountsApi#getAccountPositionById
     */
    default ResponseEntity<ValuatedPosition> getAccountPositionById(String accountId,
        String positionId,
        LocalDate date,
        String xCorrelationID,
        Boolean endOfDayIndicator) {
